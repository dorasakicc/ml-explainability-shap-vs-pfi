...
This project explores explainability techniques for machine learning models predicting household appliance energy consumption. The main goal is to compare two popular explainability methods: Permutation Feature Importance (PFI) and SHAP.
...
- The **hour of the day** appears to be the most influential variable, indicating strong daily usage patterns.  
- **Indoor temperature and humidity features** also play an important role in predicting energy consumption.  
...
- Both PFI and SHAP show broadly consistent importance rankings, suggesting reliable explanations.  
...
Further refinements, additional experiments, and extended analysis may be added over time.
